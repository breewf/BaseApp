...
import com.ghy.baseapp.component.banner.ConvenientBanner;
...
import com.ghy.baseapp.component.banner.transforms.*;
...
public class BannerTestActivity extends AbsBaseActivity {
    ...
    private void changeTransforemer(String transforemerName) {
        try {
            Class cls = Class.forName("com.ghy.baseapp.component.banner.transforms." + transforemerName);
