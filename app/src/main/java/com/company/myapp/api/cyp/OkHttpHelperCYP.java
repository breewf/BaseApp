 ...
 */
public class OkHttpHelperCYP {

    public static final int METHOD_GET = 0;
    public static final int METHOD_POST = 1;

    public OkHttpHelperCYP(BaseApiAvCYP baseApiAv) {
        startRequest(baseApiAv,null);
    }

    public OkHttpHelperCYP(BaseApiFgCYP baseApiFg) {
     ...
     * @param baseApiFg
     */
    private void startRequest(final BaseApiAvCYP baseApiAv,final BaseApiFgCYP baseApiFg) {
