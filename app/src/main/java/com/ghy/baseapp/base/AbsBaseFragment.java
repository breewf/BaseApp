...
public abstract class AbsBaseFragment extends Fragment {
     ...
     * 初始化基础控件
     */
    private ProgressView mProgressCircleFg;
    private ProgressView mProgressLineFg;

    private void initBase(View rootView) {
        mProgressCircleFg = (ProgressView) rootView.findViewById(R.id.abs_base_progressbar_circle_fg);
        mProgressLineFg = (ProgressView) rootView.findViewById(R.id.abs_base_progressbar_line_fg);
    }
    ...
    public void loadingProgressDismiss() {
        ...
        mProgressCircleFg.stop();
        mProgressLineFg.setVisibility(View.GONE);
        mProgressLineFg.stop();
    }
