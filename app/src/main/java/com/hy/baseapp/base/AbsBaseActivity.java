...
public abstract class AbsBaseActivity extends RxAppCompatActivity {
    ...
    private void initBase(View rootView) {
        mProgressCircle = (ProgressBar) rootView.findViewById(R.id.abs_base_progressbar_circle);
        mProgressLine = (ProgressBar) rootView.findViewById(R.id.abs_base_progressbar_line);
    }
