...
public class WheelView extends ScrollView {
    ...
    private TextView createView(String item) {
        ...
        int paddingBottom = dip2px(15);
        tv.setPadding(padding, padding, padding, paddingBottom);
        if (0 == itemHeight) {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                canvas.drawLine(viewWidth * 1 / 8, obtainSelectedAreaBorder()[0], viewWidth * 7 / 8, obtainSelectedAreaBorder()[0], paint);
                canvas.drawLine(viewWidth * 1 / 8, obtainSelectedAreaBorder()[1], viewWidth * 7 / 8, obtainSelectedAreaBorder()[1], paint);
            }
